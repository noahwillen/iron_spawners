...
public class IronSpawnerEntityRenderer implements BlockEntityRenderer<IronSpawnerBlockEntity> {

    public IronSpawnerEntityRenderer(BlockEntityRendererProvider.Context ctx)  {

    }


    @Override
    public void render(IronSpawnerBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
