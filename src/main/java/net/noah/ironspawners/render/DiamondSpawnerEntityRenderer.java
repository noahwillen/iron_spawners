...
public class DiamondSpawnerEntityRenderer implements BlockEntityRenderer<DiamondSpawnerBlockEntity> {

    public DiamondSpawnerEntityRenderer(BlockEntityRendererProvider.Context ctx)  {

    }


    @Override
    public void render(DiamondSpawnerBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
