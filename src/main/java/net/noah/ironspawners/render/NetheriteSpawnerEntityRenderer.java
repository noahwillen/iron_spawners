...
public class NetheriteSpawnerEntityRenderer implements BlockEntityRenderer<NetheriteSpawnerBlockEntity> {

    public NetheriteSpawnerEntityRenderer(BlockEntityRendererProvider.Context ctx)  {

    }


    @Override
    public void render(NetheriteSpawnerBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
