...
public class GoldSpawnerEntityRenderer implements BlockEntityRenderer<GoldSpawnerBlockEntity> {

    public GoldSpawnerEntityRenderer(BlockEntityRendererProvider.Context ctx)  {

    }


    @Override
    public void render(GoldSpawnerBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
